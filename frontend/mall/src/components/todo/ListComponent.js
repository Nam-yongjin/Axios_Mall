...
import PageComponents from "../common/PageComponent";

const initState = {
    dtoList: [], pageNumList: [], pageRequestDTO: null, prev: false, next: false, totalCount: 0, prevPage: 0, nextPage: 0, totalPage: 0, current: 0
}
...
const ListComponent = () => {
    ...
    return (
        <div className="border-2 border-blue-100 mt-10 mr-2 ml-2">
            ...
            <PageComponents serverData={serverData} movePage={moveToList} />
        </div>
    );
